    ...
    <div class="card">
      <form role="form">
        ...
        <div class="d-flex justify-content-end mt-4 mb-5">
                <button class="btn btn-success me-3 " style="background-color: #114232">Simpan</button>
                <button class="btn btn-danger me-4" style="background-color: #853B3B">Tolak</button>
        </div>
        </form>
    </div>
</div>
