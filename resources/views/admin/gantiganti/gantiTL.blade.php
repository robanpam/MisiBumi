    ...
    <div class="card boldborder" style="width: 100%; max-width: 80rem; ">
        ...
        <div class="card-body">
            ...
            <form action="">
                @csrf
                <div class="mb-4">
                    <input type="date" class="form-control boldborder2" custom-input" id="tglLahir" name="tglLahir " placeholder="Masukkan Tanggal lahir baru "required>
                </div>
                <div class="mb-4">
